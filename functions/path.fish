...
function __path_help
    printf "Usage :\n\n"
    printf "\t\e[1;32mpath \e[1;96moperation "
    printf "\e[1;94m<option>\e[0m \e[1;93mentrie\e[0m\n\n"
    printf "Available operation :\n\n"
    printf "\tadd      : add \e[1;93mentrie\e[0m to \e[91m\$PATH\e[0m\n"
    printf "\taddto \e[1;94mi\e[0m  : add \e[1;93mentrie\e[0m to "
    printf "\e[91m\$PATH\e[0m at index \e[1;94mi\e[0m\n"
    printf "\tdump \e[1;94mlog\e[0m : dump all entries in \e[91m\$PATH\e[0m "
    printf "to \e[1;94mlog\e[0m\n"
    printf "\t\t   if \e[1;94mlog\e[0m omitted, \e[1;94mlog\e[0m default to "
    printf "\e[91m\$XDG_CACHE_HOME\e[0m\n"
    printf "\tremove   : remove \e[1;93m[entrie..]\e[0m from "
    printf "\e[91m\$PATH\e[0m\n\t\t   \e[1;93mentrie\e[0m "
    printf "can be a list of index or path\n"
    printf "\tshow     : show all \e[91m\$PATH\e[0m entries\n"
